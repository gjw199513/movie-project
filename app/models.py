...
class User(db.Model):
    ...
    userlogs = db.relationship('Userlog', backref='user')  # 会员外键关系关联
    comments = db.relationship('Comment', backref="user")  # 评论外键关系关联
    moviewcols = db.relationship('Moviecol', backref="user")  # 收藏外键关系关联
...
class Movie(db.Model):
    ...
    moviewcols = db.relationship('Moviecol', backref="movie")  # 收藏外键关系关联
